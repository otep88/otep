...
insert into LETTCCMMNDETAILCODE(CODE_ID,CODE,CODE_NM,CODE_DC,USE_AT,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values ('COM004','BBST02','익명게시판','익명게시판','Y','2011-08-02 21:13:36','SYSTEM','2011-08-02 21:13:36','SYSTEM');
...
insert into LETTCCMMNDETAILCODE(CODE_ID,CODE,CODE_NM,CODE_DC,USE_AT,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values ('COM009','BBSA01','유효게시판','유효게시판','Y','2011-08-02 21:13:37','SYSTEM','2011-08-02 21:13:37','SYSTEM');
...
insert into LETTNROLEINFO(ROLE_CODE,ROLE_NM,ROLE_PTTRN,ROLE_DC,ROLE_TY,ROLE_SORT,ROLE_CREAT_DE) values ('uss-ion-ntmr','uss-ion-ntmr','/uss/ion/ntmr/.*.do.*','쪽지관리','url','23','2011-08-24 0:00');
...
insert into LETTNAUTHORROLERELATE(AUTHOR_CODE,ROLE_CODE,CREAT_DT) values ('ROLE_ADMIN','uss-ion-ntmr','2009-08-25 00:00:00');
insert into LETTNAUTHORROLERELATE(AUTHOR_CODE,ROLE_CODE,CREAT_DT) values ('ROLE_ADMIN','uss-ion-ntr','2009-08-25 00:00:00');
insert into LETTNAUTHORROLERELATE(AUTHOR_CODE,ROLE_CODE,CREAT_DT) values ('ROLE_ADMIN','uss-ion-nts','2009-08-25 00:00:00');
...
insert into LETTNPROGRMLIST(PROGRM_FILE_NM,PROGRM_STRE_PATH,PROGRM_KOREAN_NM,PROGRM_DC,URL) values ('EgovQustnrItemManageDetail','','항목관리상세조회','항목관리상세조회','');
...
insert into LETTNPROGRMLIST(PROGRM_FILE_NM,PROGRM_STRE_PATH,PROGRM_KOREAN_NM,PROGRM_DC,URL) values ('EgovQustnrItemManageModify','','항목관리수정','항목관리수정','');
...
insert into LETTNPROGRMLIST(PROGRM_FILE_NM,PROGRM_STRE_PATH,PROGRM_KOREAN_NM,PROGRM_DC,URL) values ('EgovQustnrManagePopupList','','설문관리목록팝업','설문관리목록팝업','');
...
insert into LETTNPROGRMLIST(PROGRM_FILE_NM,PROGRM_STRE_PATH,PROGRM_KOREAN_NM,PROGRM_DC,URL) values ('EgovQustnrQestnManageDetail','','문항관리상세조회','문항관리상세조회','');
...
insert into LETTNPROGRMLIST(PROGRM_FILE_NM,PROGRM_STRE_PATH,PROGRM_KOREAN_NM,PROGRM_DC,URL) values ('EgovQustnrQestnManageModify','','문항관리수정','문항관리수정','');
...
insert into LETTNPROGRMLIST(PROGRM_FILE_NM,PROGRM_STRE_PATH,PROGRM_KOREAN_NM,PROGRM_DC,URL) values ('EgovQustnrRespondInfoDetail','','설문조사상세조회','설문조사상세조회','');
...
insert into LETTNPROGRMLIST(PROGRM_FILE_NM,PROGRM_STRE_PATH,PROGRM_KOREAN_NM,PROGRM_DC,URL) values ('EgovQustnrRespondInfoManageRegist','','설문참여등록','설문참여등록','');
...
insert into LETTNPROGRMLIST(PROGRM_FILE_NM,PROGRM_STRE_PATH,PROGRM_KOREAN_NM,PROGRM_DC,URL) values ('EgovQustnrRespondInfoModify','','설문조사수정','설문조사수정','');
insert into LETTNPROGRMLIST(PROGRM_FILE_NM,PROGRM_STRE_PATH,PROGRM_KOREAN_NM,PROGRM_DC,URL) values ('EgovQustnrRespondInfoRegist','/uss/olp/qnn/','설문조사등록','설문조사등록','/uss/olp/qnn/EgovQustnrRespondInfoManageRegist.do');
insert into LETTNPROGRMLIST(PROGRM_FILE_NM,PROGRM_STRE_PATH,PROGRM_KOREAN_NM,PROGRM_DC,URL) values ('EgovQustnrRespondManageDetail','','응답자관리 상세조회','응답자관리 상세조회','');
...
insert into LETTNPROGRMLIST(PROGRM_FILE_NM,PROGRM_STRE_PATH,PROGRM_KOREAN_NM,PROGRM_DC,URL) values ('EgovQustnrRespondManageModify','','응답자관리 수정','응답자관리 수정','');
...
insert into LETTNPROGRMLIST(PROGRM_FILE_NM,PROGRM_STRE_PATH,PROGRM_KOREAN_NM,PROGRM_DC,URL) values ('EgovQustnrTmplatManageDetail','','설문템플릿 상세조회','설문템플릿 상세조회','');
...
insert into LETTNPROGRMLIST(PROGRM_FILE_NM,PROGRM_STRE_PATH,PROGRM_KOREAN_NM,PROGRM_DC,URL) values ('EgovQustnrTmplatManageModify','','설문템플릿 수정','설문템플릿 수정','');
...
INSERT INTO LETTNPROGRMLIST(PROGRM_FILE_NM, PROGRM_STRE_PATH, PROGRM_KOREAN_NM, PROGRM_DC, URL) VALUES ('listIndvdlInfoPolicy','/uss/sam/ipm/','개인정보보호정책확인','개인정보보호정책확인','/uss/sam/ipm/listIndvdlInfoPolicy.do');
...
insert into LETTNBBS(NTT_ID,BBS_ID,NTT_NO,NTT_SJ,NTT_CN,ANSWER_AT,PARNTSCTT_NO,ANSWER_LC,SORT_ORDR,RDCNT,USE_AT,NTCE_BGNDE,NTCE_ENDDE,NTCR_ID,NTCR_NM,PASSWORD,ATCH_FILE_ID,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values (6,'BBSMSTR_AAAAAAAAAAAA',1,'포탈사이트 샘플게시1','포탈사이트 샘플게시1','N',0,0,2,0,'Y','10000101','99991231','','','',null,NOW(),'USRCNFRM_00000000000',null,null);
insert into LETTNBBS(NTT_ID,BBS_ID,NTT_NO,NTT_SJ,NTT_CN,ANSWER_AT,PARNTSCTT_NO,ANSWER_LC,SORT_ORDR,RDCNT,USE_AT,NTCE_BGNDE,NTCE_ENDDE,NTCR_ID,NTCR_NM,PASSWORD,ATCH_FILE_ID,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values (7,'BBSMSTR_AAAAAAAAAAAA',1,'포탈사이트 샘플게시2','포탈사이트 샘플게시2','N',0,0,2,0,'Y','10000101','99991231','','','',null,NOW(),'USRCNFRM_00000000000',null,null);
insert into LETTNBBS(NTT_ID,BBS_ID,NTT_NO,NTT_SJ,NTT_CN,ANSWER_AT,PARNTSCTT_NO,ANSWER_LC,SORT_ORDR,RDCNT,USE_AT,NTCE_BGNDE,NTCE_ENDDE,NTCR_ID,NTCR_NM,PASSWORD,ATCH_FILE_ID,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values (8,'BBSMSTR_AAAAAAAAAAAA',1,'포탈사이트 샘플게시3','포탈사이트 샘플게시3','N',0,0,2,0,'Y','10000101','99991231','','','',null,NOW(),'USRCNFRM_00000000000',null,null);
insert into LETTNBBS(NTT_ID,BBS_ID,NTT_NO,NTT_SJ,NTT_CN,ANSWER_AT,PARNTSCTT_NO,ANSWER_LC,SORT_ORDR,RDCNT,USE_AT,NTCE_BGNDE,NTCE_ENDDE,NTCR_ID,NTCR_NM,PASSWORD,ATCH_FILE_ID,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values (9,'BBSMSTR_AAAAAAAAAAAA',1,'포탈사이트 샘플게시4','포탈사이트 샘플게시4','N',0,0,2,0,'Y','10000101','99991231','','','',null,NOW(),'USRCNFRM_00000000000',null,null);
insert into LETTNBBS(NTT_ID,BBS_ID,NTT_NO,NTT_SJ,NTT_CN,ANSWER_AT,PARNTSCTT_NO,ANSWER_LC,SORT_ORDR,RDCNT,USE_AT,NTCE_BGNDE,NTCE_ENDDE,NTCR_ID,NTCR_NM,PASSWORD,ATCH_FILE_ID,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values (10,'BBSMSTR_AAAAAAAAAAAA',1,'포탈사이트 샘플게시5','포탈사이트 샘플게시5','N',0,0,2,0,'Y','10000101','99991231','','','',null,NOW(),'USRCNFRM_00000000000',null,null);
...
Insert into LETTNFAQINFO (FAQ_ID, QESTN_SJ, QESTN_CN, ANSWER_CN, RDCNT, FRST_REGIST_PNTTM, FRST_REGISTER_ID, LAST_UPDT_PNTTM, LAST_UPDUSR_ID)
 Values ('FAQ_000000000000000A', 'FAQ 샘플1', 'FAQ 샘플1 - 질문내용', 'FAQ 샘플1 - 답변내용', 0, NOW(), 'USRCNFRM_00000000000', NOW(), 'USRCNFRM_00000000000');

Insert into LETTNFAQINFO (FAQ_ID, QESTN_SJ, QESTN_CN, ANSWER_CN, RDCNT, FRST_REGIST_PNTTM, FRST_REGISTER_ID, LAST_UPDT_PNTTM, LAST_UPDUSR_ID)
 Values ('FAQ_000000000000000B', 'FAQ 샘플2', 'FAQ 샘플2 - 질문내용', 'FAQ 샘플2 - 답변내용', 0, NOW(), 'USRCNFRM_00000000000', NOW(), 'USRCNFRM_00000000000');

Insert into LETTNFAQINFO (FAQ_ID, QESTN_SJ, QESTN_CN, ANSWER_CN, RDCNT, FRST_REGIST_PNTTM, FRST_REGISTER_ID, LAST_UPDT_PNTTM, LAST_UPDUSR_ID)
 Values ('FAQ_000000000000000C', 'FAQ 샘플3', 'FAQ 샘플3 - 질문내용', 'FAQ 샘플3 - 답변내용', 0, NOW(), 'USRCNFRM_00000000000', NOW(), 'USRCNFRM_00000000000');
 
  -- 우편번호
INSERT INTO LETTCZIP(ZIP, SN, CTPRVN_NM, SIGNGU_NM, EMD_NM, LI_BULD_NM, LNBR_DONG_HO, FRST_REGIST_PNTTM, FRST_REGISTER_ID, LAST_UPDT_PNTTM, LAST_UPDUSR_ID) VALUES ('100775',7381,'서울','중구','무교동','한국정보화진흥원','',NOW(),'SYSTEM',NOW(),'SYSTEM');
