...
--추가
INSERT INTO IDS ( TABLE_NAME, NEXT_ID ) VALUES ('MEMO_REPRT', 1);
INSERT INTO IDS ( TABLE_NAME, NEXT_ID ) VALUES ('MSI_ID', 1);
INSERT INTO IDS ( TABLE_NAME, NEXT_ID ) VALUES ('MTG_ID', 1);
INSERT INTO IDS ( TABLE_NAME, NEXT_ID ) VALUES ('MTG_PLACE_ID', 1);
INSERT INTO IDS ( TABLE_NAME, NEXT_ID ) VALUES ('POPUP_ID', 1);
...
--쪽지관리 추가 
insert into LETTCCMMNCODE(CODE_ID,CODE_ID_NM,CODE_ID_DC,USE_AT,CL_CODE,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values ('COM050', '수신구분', '쪽지관리', 'Y','LET',  SYSDATE, 'SYSTEM', SYSDATE, 'SYSTEM');
...
insert into LETTCCMMNDETAILCODE(CODE_ID,CODE,CODE_NM,CODE_DC,USE_AT,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values ('COM004','BBST02','익명게시판','익명게시판','Y',SYSDATE,'SYSTEM',SYSDATE,'SYSTEM');
...
insert into LETTCCMMNDETAILCODE(CODE_ID,CODE,CODE_NM,CODE_DC,USE_AT,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values ('COM009','BBSA01','유효게시판','유효게시판','Y',SYSDATE,'SYSTEM',SYSDATE,'SYSTEM');
...
--코드(쪽지추가)
insert into LETTCCMMNDETAILCODE(CODE_ID, CODE, CODE_NM, CODE_DC, USE_AT, FRST_REGIST_PNTTM, FRST_REGISTER_ID, LAST_UPDT_PNTTM, LAST_UPDUSR_ID) VALUES ('COM050', '1', '수신', '수신', 'Y',SYSDATE, 'SYSTEM', SYSDATE, 'SYSTEM');
insert into LETTCCMMNDETAILCODE(CODE_ID, CODE, CODE_NM, CODE_DC, USE_AT, FRST_REGIST_PNTTM, FRST_REGISTER_ID, LAST_UPDT_PNTTM, LAST_UPDUSR_ID) VALUES ('COM050', '2', '참조', '참조', 'Y',SYSDATE, 'SYSTEM', SYSDATE, 'SYSTEM');
...
insert into LETTNROLEINFO(ROLE_CODE,ROLE_NM,ROLE_PTTRN,ROLE_DC,ROLE_TY,ROLE_SORT,ROLE_CREAT_DE) values ('web-000021','/cop/bbs/anonymous/.*.do.*',	'/cop/bbs/anonymous/*.do', '익명게시판', 'url', '100',SYSDATE);
insert into LETTNROLEINFO(ROLE_CODE,ROLE_NM,ROLE_PTTRN,ROLE_DC,ROLE_TY,ROLE_SORT,ROLE_CREAT_DE) values ('web-000022','/validator.do',	'/validator.do', '익명게시판(validate)', 'url', '101',SYSDATE);
...
insert into LETTNROLEINFO(ROLE_CODE,ROLE_NM,ROLE_PTTRN,ROLE_DC,ROLE_TY,ROLE_SORT,ROLE_CREAT_DE) values ('uss-ion-ntmr','uss-ion-ntmr','/uss/ion/ntmr/.*.do.*','쪽지관리','url','23',SYSDATE);
insert into LETTNROLEINFO(ROLE_CODE,ROLE_NM,ROLE_PTTRN,ROLE_DC,ROLE_TY,ROLE_SORT,ROLE_CREAT_DE) values ('uss-ion-ntr','uss-ion-ntr','/uss/ion/ntr/.*.do.*','받은쪽지함관리','url','24',SYSDATE);
insert into LETTNROLEINFO(ROLE_CODE,ROLE_NM,ROLE_PTTRN,ROLE_DC,ROLE_TY,ROLE_SORT,ROLE_CREAT_DE) values ('uss-ion-nts','uss-ion-nts','/uss/ion/nts/.*.do.*','보낸쪽지함관리','url','25',SYSDATE);
...
insert into LETTNAUTHORROLERELATE(AUTHOR_CODE,ROLE_CODE,CREAT_DT) values ('ROLE_ADMIN','uss-ion-ntmr',SYSDATE);
insert into LETTNAUTHORROLERELATE(AUTHOR_CODE,ROLE_CODE,CREAT_DT) values ('ROLE_ADMIN','uss-ion-ntr',SYSDATE);
insert into LETTNAUTHORROLERELATE(AUTHOR_CODE,ROLE_CODE,CREAT_DT) values ('ROLE_ADMIN','uss-ion-nts',SYSDATE);
...
insert into LETTNPROGRMLIST(PROGRM_FILE_NM,PROGRM_STRE_PATH,PROGRM_KOREAN_NM,PROGRM_DC,URL) values ('EgovMenuManageSelect','/sym/mnu/mpm/','메뉴관리리스트','메뉴관리리스트','/sym/mnu/mpm/EgovMenuManageSelect.do');
insert into LETTNPROGRMLIST(PROGRM_FILE_NM,PROGRM_STRE_PATH,PROGRM_KOREAN_NM,PROGRM_DC,URL) values ('EgovProgramListManageSelect','/sym/prm/','프로그램관리','프로그램관리','/sym/prm/EgovProgramListManageSelect.do');
insert into LETTNPROGRMLIST(PROGRM_FILE_NM,PROGRM_STRE_PATH,PROGRM_KOREAN_NM,PROGRM_DC,URL) values ('listNoteRecptn','/uss/ion/ntr/','받은쪽지함관리','받은쪽지함관리','/uss/ion/ntr/listNoteRecptn.do');
...
--메뉴관리, 쪽지 관리 추가--
insert into LETTNMENUINFO(MENU_NM,PROGRM_FILE_NM,MENU_NO,UPPER_MENU_NO,MENU_ORDR,MENU_DC,RELATE_IMAGE_PATH,RELATE_IMAGE_NM) values ('쪽지관리','registEgovNoteManage',5490000,5000000,49,'쪽지관리','/','/');
insert into LETTNMENUINFO(MENU_NM,PROGRM_FILE_NM,MENU_NO,UPPER_MENU_NO,MENU_ORDR,MENU_DC,RELATE_IMAGE_PATH,RELATE_IMAGE_NM) values ('받은쪽지함관리','listNoteRecptn',5500000,5000000,50,'받은쪽지함관리','/','/');
insert into LETTNMENUINFO(MENU_NM,PROGRM_FILE_NM,MENU_NO,UPPER_MENU_NO,MENU_ORDR,MENU_DC,RELATE_IMAGE_PATH,RELATE_IMAGE_NM) values ('보낸쪽지함관리','listNoteTrnsmit',5510000,5000000,51,'보낸쪽지함관리','/','/');
...
insert into LETTNMENUINFO(MENU_NM,PROGRM_FILE_NM,MENU_NO,UPPER_MENU_NO,MENU_ORDR,MENU_DC,RELATE_IMAGE_PATH,RELATE_IMAGE_NM) values ('메뉴리스트관리','EgovMenuListSelect',6130000,6000000,13,'메뉴리스트관리','/','/');
insert into LETTNMENUINFO(MENU_NM,PROGRM_FILE_NM,MENU_NO,UPPER_MENU_NO,MENU_ORDR,MENU_DC,RELATE_IMAGE_PATH,RELATE_IMAGE_NM) values ('메뉴관리리스트','EgovMenuManageSelect',6140000,6000000,14,'메뉴관리리스트','/','/');
...
insert into LETTNMENUCREATDTLS(MENU_NO,AUTHOR_CODE,MAPNG_CREAT_ID) values (5490000,'ROLE_ADMIN',null);
insert into LETTNMENUCREATDTLS(MENU_NO,AUTHOR_CODE,MAPNG_CREAT_ID) values (5500000,'ROLE_ADMIN',null);
insert into LETTNMENUCREATDTLS(MENU_NO,AUTHOR_CODE,MAPNG_CREAT_ID) values (5510000,'ROLE_ADMIN',null);
insert into LETTNMENUCREATDTLS(MENU_NO,AUTHOR_CODE,MAPNG_CREAT_ID) values (5340000,'ROLE_ADMIN',null);
