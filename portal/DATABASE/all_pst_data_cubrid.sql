...
-- 분류코드
insert into LETTCCMMNCLCODE(CL_CODE,CL_CODE_NM,CL_CODE_DC,USE_AT,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values ('LET','전자정부 프레임워크 경량환경 템플릿','전자정부 프레임워크 경량환경 템플릿1','Y',SYSDATETIME,'SYSTEM',SYSDATETIME,'SYSTEM');
...
insert into LETTCCMMNCODE(CODE_ID,CODE_ID_NM,CODE_ID_DC,USE_AT,CL_CODE,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values ('COM013','회원상태','회원 가입 신청/승인/삭제를 위한 상태 구분','Y','LET',SYSDATETIME,'SYSTEM',SYSDATETIME,'SYSTEM');
insert into LETTCCMMNCODE(CODE_ID,CODE_ID_NM,CODE_ID_DC,USE_AT,CL_CODE,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values ('COM014','성별구분','남녀 성별 구분','Y','LET',SYSDATETIME,'SYSTEM',SYSDATETIME,'SYSTEM');
insert into LETTCCMMNCODE(CODE_ID,CODE_ID_NM,CODE_ID_DC,USE_AT,CL_CODE,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values ('COM018','질문유형','질문유형 객관식/주관식 상태구분','Y','LET',SYSDATETIME,'SYSTEM',SYSDATETIME,'SYSTEM');
insert into LETTCCMMNCODE(CODE_ID,CODE_ID_NM,CODE_ID_DC,USE_AT,CL_CODE,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values ('COM022','비밀번호 힌트','비밀번호 힌트 구분코드','Y','LET',SYSDATETIME,'SYSTEM',SYSDATETIME,'SYSTEM');
insert into LETTCCMMNCODE(CODE_ID,CODE_ID_NM,CODE_ID_DC,USE_AT,CL_CODE,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values ('COM028','질의응답처리상태','Q/A 처리상태코드','Y','LET',SYSDATETIME,'SYSTEM',SYSDATETIME,'SYSTEM');
insert into LETTCCMMNCODE(CODE_ID,CODE_ID_NM,CODE_ID_DC,USE_AT,CL_CODE,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values ('COM029','롤유형코드','롤유형코드','Y','LET',SYSDATETIME,'SYSTEM',SYSDATETIME,'SYSTEM');
insert into LETTCCMMNCODE(CODE_ID,CODE_ID_NM,CODE_ID_DC,USE_AT,CL_CODE,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values ('COM034','직업유형','직업유형코드','Y','LET',SYSDATETIME,'SYSTEM',SYSDATETIME,'SYSTEM');
ALTER CLASS [lettccmmncode] ADD CONSTRAINT [lettccmmncode_ibfk_1] FOREIGN KEY([cl_code]) REFERENCES [lettccmmnclcode] ON DELETE RESTRICT ON UPDATE RESTRICT ;
...
insert into LETTCCMMNDETAILCODE(CODE_ID,CODE,CODE_NM,CODE_DC,USE_AT,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values ('COM013','A','회원 가입 신청 상태','회원 가입 신청 상태','Y',SYSDATETIME,'SYSTEM',SYSDATETIME,'SYSTEM');
insert into LETTCCMMNDETAILCODE(CODE_ID,CODE,CODE_NM,CODE_DC,USE_AT,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values ('COM013','D','회원 가입 삭제 상태','회원 가입 삭제 상태','Y',SYSDATETIME,'SYSTEM',SYSDATETIME,'SYSTEM');
insert into LETTCCMMNDETAILCODE(CODE_ID,CODE,CODE_NM,CODE_DC,USE_AT,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values ('COM013','P','회원 가입 승인 상태','회원 가입 승인 상태','Y',SYSDATETIME,'SYSTEM',SYSDATETIME,'SYSTEM');
insert into LETTCCMMNDETAILCODE(CODE_ID,CODE,CODE_NM,CODE_DC,USE_AT,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values ('COM014','F','여자','여자','Y',SYSDATETIME,'SYSTEM',SYSDATETIME,'SYSTEM');
insert into LETTCCMMNDETAILCODE(CODE_ID,CODE,CODE_NM,CODE_DC,USE_AT,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values ('COM014','M','남자','남자','Y',SYSDATETIME,'SYSTEM',SYSDATETIME,'SYSTEM');
insert into LETTCCMMNDETAILCODE(CODE_ID,CODE,CODE_NM,CODE_DC,USE_AT,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values ('COM018','1','객관식','객관식','Y',SYSDATETIME,'SYSTEM',SYSDATETIME,'SYSTEM');
insert into LETTCCMMNDETAILCODE(CODE_ID,CODE,CODE_NM,CODE_DC,USE_AT,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values ('COM018','2','주관식','주관식','Y',SYSDATETIME,'SYSTEM',SYSDATETIME,'SYSTEM');
insert into LETTCCMMNDETAILCODE(CODE_ID,CODE,CODE_NM,CODE_DC,USE_AT,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values ('COM022',' P01','가장 기억에 남는 장소는?','가장 기억에 남는 장소는?','Y',SYSDATETIME,'SYSTEM',SYSDATETIME,'SYSTEM');
insert into LETTCCMMNDETAILCODE(CODE_ID,CODE,CODE_NM,CODE_DC,USE_AT,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values ('COM022',' P02','나의 좌우명은?','나의 좌우명은?','Y',SYSDATETIME,'SYSTEM',SYSDATETIME,'SYSTEM');
insert into LETTCCMMNDETAILCODE(CODE_ID,CODE,CODE_NM,CODE_DC,USE_AT,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values ('COM022',' P03','나의 보물 제1호는?','나의 보물 제1호는?','Y',SYSDATETIME,'SYSTEM',SYSDATETIME,'SYSTEM');
insert into LETTCCMMNDETAILCODE(CODE_ID,CODE,CODE_NM,CODE_DC,USE_AT,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values ('COM022',' P04','가장 기억에 남는 선생님 성함은?','가장 기억에 남는 선생님 성함은?','Y',SYSDATETIME,'SYSTEM',SYSDATETIME,'SYSTEM');
insert into LETTCCMMNDETAILCODE(CODE_ID,CODE,CODE_NM,CODE_DC,USE_AT,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values ('COM022',' P05','다른 사람은 모르는 나만의 신체비밀은?','다른 사람은 모르는 나만의 신체비밀은?','Y',SYSDATETIME,'SYSTEM',SYSDATETIME,'SYSTEM');
insert into LETTCCMMNDETAILCODE(CODE_ID,CODE,CODE_NM,CODE_DC,USE_AT,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values ('COM028','1','접수대기','접수대기','Y',SYSDATETIME,'SYSTEM',SYSDATETIME,'SYSTEM');
insert into LETTCCMMNDETAILCODE(CODE_ID,CODE,CODE_NM,CODE_DC,USE_AT,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values ('COM028','2','접수','접수','Y',SYSDATETIME,'SYSTEM',SYSDATETIME,'SYSTEM');
insert into LETTCCMMNDETAILCODE(CODE_ID,CODE,CODE_NM,CODE_DC,USE_AT,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values ('COM028','3','완료','완료','Y',SYSDATETIME,'SYSTEM',SYSDATETIME,'SYSTEM');
insert into LETTCCMMNDETAILCODE(CODE_ID,CODE,CODE_NM,CODE_DC,USE_AT,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values ('COM029','url','URL','URL','Y',SYSDATETIME,'SYSTEM',SYSDATETIME,'SYSTEM');
insert into LETTCCMMNDETAILCODE(CODE_ID,CODE,CODE_NM,CODE_DC,USE_AT,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values ('COM034','1','학생','학생','Y',SYSDATETIME,'SYSTEM',SYSDATETIME,'SYSTEM');
insert into LETTCCMMNDETAILCODE(CODE_ID,CODE,CODE_NM,CODE_DC,USE_AT,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values ('COM034','2','대학생','대학생','Y',SYSDATETIME,'SYSTEM',SYSDATETIME,'SYSTEM');
insert into LETTCCMMNDETAILCODE(CODE_ID,CODE,CODE_NM,CODE_DC,USE_AT,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values ('COM034','3','군인','군인','Y',SYSDATETIME,'SYSTEM',SYSDATETIME,'SYSTEM');
insert into LETTCCMMNDETAILCODE(CODE_ID,CODE,CODE_NM,CODE_DC,USE_AT,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values ('COM034','4','교사','교사','Y',SYSDATETIME,'SYSTEM',SYSDATETIME,'SYSTEM');
insert into LETTCCMMNDETAILCODE(CODE_ID,CODE,CODE_NM,CODE_DC,USE_AT,FRST_REGIST_PNTTM,FRST_REGISTER_ID,LAST_UPDT_PNTTM,LAST_UPDUSR_ID) values ('COM034','5','기타','기타','Y',SYSDATETIME,'SYSTEM',SYSDATETIME,'SYSTEM');
ALTER CLASS [lettccmmndetailcode] ADD CONSTRAINT [lettccmmndetailcode_ibfk_1] FOREIGN KEY([code_id]) REFERENCES [lettccmmncode] ON DELETE RESTRICT ON UPDATE RESTRICT ;
...
-- 권한정보
insert into LETTNAUTHORINFO(AUTHOR_CODE,AUTHOR_NM,AUTHOR_DC,AUTHOR_CREAT_DE) values ('ROLE_ADMIN','관리자','관리자',SYSDATETIME);
insert into LETTNAUTHORINFO(AUTHOR_CODE,AUTHOR_NM,AUTHOR_DC,AUTHOR_CREAT_DE) values ('ROLE_ANONYMOUS','오픈기능','오픈기능',SYSDATETIME);
insert into LETTNAUTHORINFO(AUTHOR_CODE,AUTHOR_NM,AUTHOR_DC,AUTHOR_CREAT_DE) values ('ROLE_USER_MEMBER','담당자','회원',SYSDATETIME);
...
ALTER CLASS [lettnroles_hierarchy] ADD CONSTRAINT [lettnroles_hierarchy_ibfk_2] FOREIGN KEY([chldrn_role]) REFERENCES [lettnauthorinfo] ON DELETE CASCADE ON UPDATE RESTRICT ;
ALTER CLASS [lettnroles_hierarchy] ADD CONSTRAINT [lettnroles_hierarchy_ibfk_1] FOREIGN KEY([parnts_role]) REFERENCES [lettnauthorinfo] ON DELETE CASCADE ON UPDATE RESTRICT ;


-- 롤정보
insert into LETTNROLEINFO(ROLE_CODE,ROLE_NM,ROLE_PTTRN,ROLE_DC,ROLE_TY,ROLE_SORT,ROLE_CREAT_DE) values ('cmm-uss-umt','cmm-uss-umt','/cmm/uss/umt/.*.do.*','아이디중복확인','url','1',SYSDATETIME);
insert into LETTNROLEINFO(ROLE_CODE,ROLE_NM,ROLE_PTTRN,ROLE_DC,ROLE_TY,ROLE_SORT,ROLE_CREAT_DE) values ('cop-bbs','cop-bbs','/cop/bbs/.*.do.*','게시판','url','2',SYSDATETIME);
insert into LETTNROLEINFO(ROLE_CODE,ROLE_NM,ROLE_PTTRN,ROLE_DC,ROLE_TY,ROLE_SORT,ROLE_CREAT_DE) values ('cop-com','cop-com','/cop/com/.*.do.*','게시판사용','url','3',SYSDATETIME);
insert into LETTNROLEINFO(ROLE_CODE,ROLE_NM,ROLE_PTTRN,ROLE_DC,ROLE_TY,ROLE_SORT,ROLE_CREAT_DE) values ('sec-gmt','sec-gmt','/sec/gmt/.*.do.*','그룹관리','url','4',SYSDATETIME);
insert into LETTNROLEINFO(ROLE_CODE,ROLE_NM,ROLE_PTTRN,ROLE_DC,ROLE_TY,ROLE_SORT,ROLE_CREAT_DE) values ('sec-ram','sec-ram','/sec/ram/.*.do.*','권한관리','url','5',SYSDATETIME);
insert into LETTNROLEINFO(ROLE_CODE,ROLE_NM,ROLE_PTTRN,ROLE_DC,ROLE_TY,ROLE_SORT,ROLE_CREAT_DE) values ('sec-rgm','sec-rgm','/sec/rgm/.*.do.*','권한그룹관리','url','6',SYSDATETIME);
insert into LETTNROLEINFO(ROLE_CODE,ROLE_NM,ROLE_PTTRN,ROLE_DC,ROLE_TY,ROLE_SORT,ROLE_CREAT_DE) values ('sec-rmt','sec-rmt','/sec/rmt/.*.do.*','롤관리','url','7',SYSDATETIME);
insert into LETTNROLEINFO(ROLE_CODE,ROLE_NM,ROLE_PTTRN,ROLE_DC,ROLE_TY,ROLE_SORT,ROLE_CREAT_DE) values ('uss-ion-bnr','uss-ion-bnr','/uss/ion/bnr/.*.do.*','배너관리','url','8',SYSDATETIME);
insert into LETTNROLEINFO(ROLE_CODE,ROLE_NM,ROLE_PTTRN,ROLE_DC,ROLE_TY,ROLE_SORT,ROLE_CREAT_DE) values ('uss-olh-faq','uss-olh-faq','/uss/olh/faq/.*.do.*','FAQ','url','9',SYSDATETIME);
insert into LETTNROLEINFO(ROLE_CODE,ROLE_NM,ROLE_PTTRN,ROLE_DC,ROLE_TY,ROLE_SORT,ROLE_CREAT_DE) values ('uss-olh-qna','uss-olh-qna','/uss/olh/qna/.*.do.*','QnA','url','10',SYSDATETIME);
insert into LETTNROLEINFO(ROLE_CODE,ROLE_NM,ROLE_PTTRN,ROLE_DC,ROLE_TY,ROLE_SORT,ROLE_CREAT_DE) values ('uss-olh-qnm','uss-olh-qnm','/uss/olh/qnm/.*.do.*','QnA답변','url','11',SYSDATETIME);
insert into LETTNROLEINFO(ROLE_CODE,ROLE_NM,ROLE_PTTRN,ROLE_DC,ROLE_TY,ROLE_SORT,ROLE_CREAT_DE) values ('uss-olp-qim','uss-olp-qim','/uss/olp/qim/.*.do.*','항목관리','url','12',SYSDATETIME);
insert into LETTNROLEINFO(ROLE_CODE,ROLE_NM,ROLE_PTTRN,ROLE_DC,ROLE_TY,ROLE_SORT,ROLE_CREAT_DE) values ('uss-olp-qmc','uss-olp-qmc','/uss/olp/qmc/.*.do.*','설문관리','url','13',SYSDATETIME);
insert into LETTNROLEINFO(ROLE_CODE,ROLE_NM,ROLE_PTTRN,ROLE_DC,ROLE_TY,ROLE_SORT,ROLE_CREAT_DE) values ('uss-olp-qnn','uss-olp-qnn','/uss/olp/qnn/.*.do.*','설문참여','url','14',SYSDATETIME);
insert into LETTNROLEINFO(ROLE_CODE,ROLE_NM,ROLE_PTTRN,ROLE_DC,ROLE_TY,ROLE_SORT,ROLE_CREAT_DE) values ('uss-olp-qqm','uss-olp-qqm','/uss/olp/qqm/.*.do.*','문항관리','url','15',SYSDATETIME);
insert into LETTNROLEINFO(ROLE_CODE,ROLE_NM,ROLE_PTTRN,ROLE_DC,ROLE_TY,ROLE_SORT,ROLE_CREAT_DE) values ('uss-olp-qri','uss-olp-qri','/uss/olp/qri/.*.do.*','설문조사','url','16',SYSDATETIME);
insert into LETTNROLEINFO(ROLE_CODE,ROLE_NM,ROLE_PTTRN,ROLE_DC,ROLE_TY,ROLE_SORT,ROLE_CREAT_DE) values ('uss-olp-qrm','uss-olp-qrm','/uss/olp/qrm/.*.do.*','응답자관리','url','17',SYSDATETIME);
insert into LETTNROLEINFO(ROLE_CODE,ROLE_NM,ROLE_PTTRN,ROLE_DC,ROLE_TY,ROLE_SORT,ROLE_CREAT_DE) values ('uss-olp-qtm','uss-olp-qtm','/uss/olp/qtm/.*.do.*','설문템플릿','url','18',SYSDATETIME);
insert into LETTNROLEINFO(ROLE_CODE,ROLE_NM,ROLE_PTTRN,ROLE_DC,ROLE_TY,ROLE_SORT,ROLE_CREAT_DE) values ('uss-sam-ipm','uss-sam-ipm','/uss/sam/ipm/.*.do.*','개인정보보호정책','url','19',SYSDATETIME);
insert into LETTNROLEINFO(ROLE_CODE,ROLE_NM,ROLE_PTTRN,ROLE_DC,ROLE_TY,ROLE_SORT,ROLE_CREAT_DE) values ('uss-sam-stp','uss-sam-stp','/uss/sam/stp/.*.do.*','약관','url','20',SYSDATETIME);
insert into LETTNROLEINFO(ROLE_CODE,ROLE_NM,ROLE_PTTRN,ROLE_DC,ROLE_TY,ROLE_SORT,ROLE_CREAT_DE) values ('uss-umt-cmm','uss-umt-cmm','/uss/umt/cmm/.*.do.*','일반회원가입신청','url','21',SYSDATETIME);
insert into LETTNROLEINFO(ROLE_CODE,ROLE_NM,ROLE_PTTRN,ROLE_DC,ROLE_TY,ROLE_SORT,ROLE_CREAT_DE) values ('uss-umt-mber','uss-umt-mber','/uss/umt/mber/.*.do.*','일반회원관리','url','22',SYSDATETIME);


-- 권한별 롤
insert into LETTNAUTHORROLERELATE(AUTHOR_CODE,ROLE_CODE,CREAT_DT) values ('ROLE_ADMIN','cmm-uss-umt',SYSDATETIME);
insert into LETTNAUTHORROLERELATE(AUTHOR_CODE,ROLE_CODE,CREAT_DT) values ('ROLE_ADMIN','sec-gmt',SYSDATETIME);
insert into LETTNAUTHORROLERELATE(AUTHOR_CODE,ROLE_CODE,CREAT_DT) values ('ROLE_ADMIN','sec-ram',SYSDATETIME);
insert into LETTNAUTHORROLERELATE(AUTHOR_CODE,ROLE_CODE,CREAT_DT) values ('ROLE_ADMIN','sec-rgm',SYSDATETIME);
insert into LETTNAUTHORROLERELATE(AUTHOR_CODE,ROLE_CODE,CREAT_DT) values ('ROLE_ADMIN','sec-rmt',SYSDATETIME);
insert into LETTNAUTHORROLERELATE(AUTHOR_CODE,ROLE_CODE,CREAT_DT) values ('ROLE_ADMIN','uss-umt-mber',SYSDATETIME);
insert into LETTNAUTHORROLERELATE(AUTHOR_CODE,ROLE_CODE,CREAT_DT) values ('ROLE_ANONYMOUS','cop-bbs',SYSDATETIME);
insert into LETTNAUTHORROLERELATE(AUTHOR_CODE,ROLE_CODE,CREAT_DT) values ('ROLE_ANONYMOUS','uss-olh-faq',SYSDATETIME);
insert into LETTNAUTHORROLERELATE(AUTHOR_CODE,ROLE_CODE,CREAT_DT) values ('ROLE_ANONYMOUS','uss-olh-qna',SYSDATETIME);
insert into LETTNAUTHORROLERELATE(AUTHOR_CODE,ROLE_CODE,CREAT_DT) values ('ROLE_ANONYMOUS','uss-olp-qnn',SYSDATETIME);
insert into LETTNAUTHORROLERELATE(AUTHOR_CODE,ROLE_CODE,CREAT_DT) values ('ROLE_ANONYMOUS','uss-umt-cmm',SYSDATETIME);
insert into LETTNAUTHORROLERELATE(AUTHOR_CODE,ROLE_CODE,CREAT_DT) values ('ROLE_USER_MEMBER','cop-com',SYSDATETIME);
insert into LETTNAUTHORROLERELATE(AUTHOR_CODE,ROLE_CODE,CREAT_DT) values ('ROLE_USER_MEMBER','uss-ion-bnr',SYSDATETIME);
insert into LETTNAUTHORROLERELATE(AUTHOR_CODE,ROLE_CODE,CREAT_DT) values ('ROLE_USER_MEMBER','uss-olh-qnm',SYSDATETIME);
insert into LETTNAUTHORROLERELATE(AUTHOR_CODE,ROLE_CODE,CREAT_DT) values ('ROLE_USER_MEMBER','uss-olp-qim',SYSDATETIME);
insert into LETTNAUTHORROLERELATE(AUTHOR_CODE,ROLE_CODE,CREAT_DT) values ('ROLE_USER_MEMBER','uss-olp-qmc',SYSDATETIME);
insert into LETTNAUTHORROLERELATE(AUTHOR_CODE,ROLE_CODE,CREAT_DT) values ('ROLE_USER_MEMBER','uss-olp-qqm',SYSDATETIME);
insert into LETTNAUTHORROLERELATE(AUTHOR_CODE,ROLE_CODE,CREAT_DT) values ('ROLE_USER_MEMBER','uss-olp-qri',SYSDATETIME);
insert into LETTNAUTHORROLERELATE(AUTHOR_CODE,ROLE_CODE,CREAT_DT) values ('ROLE_USER_MEMBER','uss-olp-qrm',SYSDATETIME);
insert into LETTNAUTHORROLERELATE(AUTHOR_CODE,ROLE_CODE,CREAT_DT) values ('ROLE_USER_MEMBER','uss-olp-qtm',SYSDATETIME);
insert into LETTNAUTHORROLERELATE(AUTHOR_CODE,ROLE_CODE,CREAT_DT) values ('ROLE_USER_MEMBER','uss-sam-ipm',SYSDATETIME);
insert into LETTNAUTHORROLERELATE(AUTHOR_CODE,ROLE_CODE,CREAT_DT) values ('ROLE_USER_MEMBER','uss-sam-stp',SYSDATETIME);
ALTER CLASS [lettnauthorrolerelate] ADD CONSTRAINT [lettnauthorrolerelate_ibfk_2] FOREIGN KEY([role_code]) REFERENCES [lettnroleinfo] ON DELETE CASCADE ON UPDATE RESTRICT ;
ALTER CLASS [lettnauthorrolerelate] ADD CONSTRAINT [lettnauthorrolerelate_ibfk_1] FOREIGN KEY([author_code]) REFERENCES [lettnauthorinfo] ON DELETE CASCADE ON UPDATE RESTRICT ;


-- 사용자(회원)정보
insert into LETTNGNRLMBER(MBER_ID,PASSWORD,PASSWORD_HINT,PASSWORD_CNSR,IHIDNUM,MBER_NM,ZIP,ADRES,AREA_NO,MBER_STTUS,DETAIL_ADRES,END_TELNO,MBTLNUM,GROUP_ID,MBER_FXNUM,MBER_EMAIL_ADRES,MIDDLE_TELNO,SBSCRB_DE,SEXDSTN_CODE,ESNTL_ID) values ('admin','a4ayc/80/OGda4BO/1o/V0etpOqiLx1JwB5S3beHW0s=','P01','123','','관리자','','','','P','','','','GROUP_00000000000000','','','',SYSDATETIME,'','USRCNFRM_00000000000');
insert into LETTNGNRLMBER(MBER_ID,PASSWORD,PASSWORD_HINT,PASSWORD_CNSR,IHIDNUM,MBER_NM,ZIP,ADRES,AREA_NO,MBER_STTUS,DETAIL_ADRES,END_TELNO,MBTLNUM,GROUP_ID,MBER_FXNUM,MBER_EMAIL_ADRES,MIDDLE_TELNO,SBSCRB_DE,SEXDSTN_CODE,ESNTL_ID) values ('user1','a4ayc/80/OGda4BO/1o/V0etpOqiLx1JwB5S3beHW0s=','P01','123','','회원1','','','','P','','','','GROUP_00000000000000','','','',SYSDATETIME,'','USRCNFRM_00000000001');
ALTER CLASS [lettngnrlmber] ADD CONSTRAINT [lettngnrlmber_ibfk_1] FOREIGN KEY([group_id]) REFERENCES [lettnauthorgroupinfo] ON DELETE CASCADE ON UPDATE RESTRICT ;
...
ALTER CLASS [lettnemplyrscrtyestbs] ADD CONSTRAINT [lettnemplyrscrtyestbs_ibfk_4] FOREIGN KEY([author_code]) REFERENCES [lettnauthorinfo] ON DELETE RESTRICT ON UPDATE RESTRICT ;
...
insert into LETTNBBSMASTER(BBS_ID,BBS_NM,BBS_INTRCN,BBS_TY_CODE,BBS_ATTRB_CODE,REPLY_POSBL_AT,FILE_ATCH_POSBL_AT,ATCH_POSBL_FILE_NUMBER,ATCH_POSBL_FILE_SIZE,USE_AT,TMPLAT_ID,FRST_REGISTER_ID,FRST_REGIST_PNTTM,LAST_UPDUSR_ID,LAST_UPDT_PNTTM) values ('BBSMSTR_BBBBBBBBBBBB','자유게시판','자유게시판(갤러리 게시판)','BBST01','BBSA02','Y','Y',2,5242880,'Y','TMPLAT_BOARD_DEFAULT','USRCNFRM_00000000000',SYSDATETIME,'USRCNFRM_00000000000',SYSDATETIME);
...
ALTER CLASS [lettnbbsuse] ADD CONSTRAINT [lettnbbsuse_ibfk_1] FOREIGN KEY([bbs_id]) REFERENCES [lettnbbsmaster] ON DELETE RESTRICT ON UPDATE RESTRICT ;
...
ALTER CLASS [lettnmenuinfo] ADD CONSTRAINT [lettnmenuinfo_ibfk_2] FOREIGN KEY([upper_menu_no]) REFERENCES [lettnmenuinfo] ON DELETE RESTRICT ON UPDATE RESTRICT ;
ALTER CLASS [lettnmenuinfo] ADD CONSTRAINT [lettnmenuinfo_ibfk_1] FOREIGN KEY([progrm_file_nm]) REFERENCES [lettnprogrmlist] ON DELETE CASCADE ON UPDATE RESTRICT ;
...
ALTER CLASS [lettnmenucreatdtls] ADD CONSTRAINT [lettnmenucreatdtls_ibfk_3] FOREIGN KEY([author_code]) REFERENCES [lettnauthorinfo] ON DELETE RESTRICT ON UPDATE RESTRICT ;
ALTER CLASS [lettnmenucreatdtls] ADD CONSTRAINT [lettnmenucreatdtls_ibfk_1] FOREIGN KEY([menu_no]) REFERENCES [lettnmenuinfo] ON DELETE CASCADE ON UPDATE RESTRICT ;
...
Insert into LETTNFAQINFO (FAQ_ID, QESTN_SJ, QESTN_CN, ANSWER_CN, RDCNT, FRST_REGIST_PNTTM, FRST_REGISTER_ID, LAST_UPDT_PNTTM, LAST_UPDUSR_ID)
 Values ('FAQ_000000000000000A', 'FAQ 샘플1', 'FAQ 샘플1 - 질문내용', 'FAQ 샘플1 - 답변내용', 0, SYSDATETIME, 'USRCNFRM_00000000000', SYSDATETIME, 'USRCNFRM_00000000000');
Insert into LETTNFAQINFO (FAQ_ID, QESTN_SJ, QESTN_CN, ANSWER_CN, RDCNT, FRST_REGIST_PNTTM, FRST_REGISTER_ID, LAST_UPDT_PNTTM, LAST_UPDUSR_ID)
 Values ('FAQ_000000000000000B', 'FAQ 샘플2', 'FAQ 샘플2 - 질문내용', 'FAQ 샘플2 - 답변내용', 0, SYSDATETIME, 'USRCNFRM_00000000000', SYSDATETIME, 'USRCNFRM_00000000000');
Insert into LETTNFAQINFO (FAQ_ID, QESTN_SJ, QESTN_CN, ANSWER_CN, RDCNT, FRST_REGIST_PNTTM, FRST_REGISTER_ID, LAST_UPDT_PNTTM, LAST_UPDUSR_ID)
 Values ('FAQ_000000000000000C', 'FAQ 샘플3', 'FAQ 샘플3 - 질문내용', 'FAQ 샘플3 - 답변내용', 0, SYSDATETIME, 'USRCNFRM_00000000000', SYSDATETIME, 'USRCNFRM_00000000000');

 
-- FK제약 조건 등록
ALTER CLASS [lettnfiledetail] ADD CONSTRAINT [lettnfiledetail_ibfk_1] FOREIGN KEY([atch_file_id]) REFERENCES [lettnfile] ON DELETE RESTRICT ON UPDATE RESTRICT ;
ALTER CLASS [lettnfaqinfo] ADD CONSTRAINT [lettnfaqinfo_ibfk_1] FOREIGN KEY([atch_file_id]) REFERENCES [lettnfile] ON DELETE RESTRICT ON UPDATE RESTRICT ;
ALTER CLASS [lettnbbs] ADD CONSTRAINT [lettnbbs_ibfk_1] FOREIGN KEY([bbs_id]) REFERENCES [lettnbbsmaster] ON DELETE RESTRICT ON UPDATE RESTRICT ;
ALTER CLASS [lettnemplyrinfo] ADD CONSTRAINT [lettnemplyrinfo_ibfk_2] FOREIGN KEY([group_id]) REFERENCES [lettnauthorgroupinfo] ON DELETE CASCADE ON UPDATE RESTRICT ;
ALTER CLASS [lettnemplyrinfo] ADD CONSTRAINT [lettnemplyrinfo_ibfk_1] FOREIGN KEY([orgnzt_id]) REFERENCES [lettnorgnztinfo] ON DELETE CASCADE ON UPDATE RESTRICT ;
ALTER CLASS [lettnentrprsmber] ADD CONSTRAINT [lettnentrprsmber_ibfk_1] FOREIGN KEY([group_id]) REFERENCES [lettnauthorgroupinfo] ON DELETE CASCADE ON UPDATE RESTRICT ;
ALTER CLASS [lettnqestnrinfo] ADD CONSTRAINT [lettnqestnrinfo_ibfk_1] FOREIGN KEY([qustnr_tmplat_id]) REFERENCES [lettnqustnrtmplat] ON DELETE RESTRICT ON UPDATE RESTRICT ;
ALTER CLASS [lettnqustnrqesitm] ADD CONSTRAINT [lettnqustnrqesitm_ibfk_1] FOREIGN KEY([qustnr_tmplat_id], [qestnr_id]) REFERENCES [lettnqestnrinfo] ON DELETE RESTRICT ON UPDATE RESTRICT ;
ALTER CLASS [lettnqustnriem] ADD CONSTRAINT [lettnqustnriem_ibfk_1] FOREIGN KEY([qestnr_id], [qustnr_qesitm_id], [qustnr_tmplat_id]) REFERENCES [lettnqustnrqesitm] ON DELETE RESTRICT ON UPDATE RESTRICT ;
ALTER CLASS [lettnqustnrrespondinfo] ADD CONSTRAINT [lettnqustnrrespondinfo_ibfk_1] FOREIGN KEY([qustnr_tmplat_id], [qestnr_id]) REFERENCES [lettnqestnrinfo] ON DELETE RESTRICT ON UPDATE RESTRICT ;
ALTER CLASS [lettnqustnrrspnsresult] ADD CONSTRAINT [lettnqustnrrspnsresult_ibfk_1] FOREIGN KEY([qestnr_id], [qustnr_qesitm_id], [qustnr_tmplat_id]) REFERENCES [lettnqustnrqesitm] ON DELETE RESTRICT ON UPDATE RESTRICT ;