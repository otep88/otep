...
<c:set var="ImgUrl" value="/images/egovframework/com/uss/ion/ntr/"/>
...
<tr>
	...
	<tr>
		...
		<td class="btnBackground"><input type="submit" value="<spring:message code="button.inquire" />" onclick="fn_egov_search_NoteRecptn(); return false;" class="btnNew" style="height:20px;width:26px;" ></td>
		...
		<td class="btnBackground"><input type="button" value="삭제" onclick="fn_egov_delete_NoteRecptn(); return false;" class="btnNew" style="height:20px;width:26px;" ></td>
		<td><img src="<c:out value="${ImgUrl}"/>button/bu2_right.gif" width="8" height="20" alt="버튼이미지"></td>
	</tr>
	</table>
	</th>
