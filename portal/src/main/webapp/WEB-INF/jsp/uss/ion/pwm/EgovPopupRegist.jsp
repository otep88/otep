...
<c:set var="CssUrl" value="${pageContext.request.contextPath}/css/" />
...
<table width="100%" cellpadding="8" class="table-search" border="0" summary="상단 타이틀을 제공한다.">
 <tr>
  <td width="100%"class="title_left">
   <img src="${ImgUrl}icon/tit_icon.gif" width="16" height="16" hspace="3" align="middle" alt="팝업창관리  등록">&nbsp;팝업창관리 등록</td>
 </tr>
</table>
<!--  줄간격조정  -->
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="팝업창관리  입력을 제공한다.">
  <tr>
  ...
  <tr>
    <th height="23" class="required_text" ><label id="IdPopupWSize">팝업창사이즈</label><img src="${ImgUrl}icon/required.gif" alt="필수입력" title="필수입력" width="15" height="15"></th>
    <td>
  ...
  <tr>
    ...
    <input type="text" name="ntceBgndeYYYMMDD" id="ntceBgndeYYYMMDD" size="10" maxlength="10" class="readOnlyClass" readonly title="게시기간">
    ...
    &nbsp&nbsp~&nbsp&nbsp
    <input type="text" name="ntceEnddeYYYMMDD" id="ntceEnddeYYYMMDD" size="10" maxlength="10" class="readOnlyClass" readonly title="게시기간">
  ...
  <tr>
    <th width="20%" height="23" class="required_text" nowrap ><label id="IdNtceAt">계시 상태</label><img src="${ImgUrl}icon/required.gif" alt="필수입력" title="필수입력" width="15" height="15"></th>
    <td width="80%">
...
<tr>
  ...
  <a href="JavaScript:fn_egov_save_PopupManage();"><spring:message code="button.save" /></a>
  </td>
  <td><img src="<c:out value="${ImgUrl}" />btn/bu2_right.gif" width="8" height="20" alt="버튼이미지"></td>
</tr>
</table>
