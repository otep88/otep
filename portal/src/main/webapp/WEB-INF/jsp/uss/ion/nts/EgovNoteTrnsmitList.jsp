...
<c:set var="ImgUrl" value="/images/egovframework/com/uss/ion/nts/"/>
  ...
  <th width="60px" align="center">
   <table border="0" cellspacing="0" cellpadding="0" align="center" summary="조회/삭제 버튼을 제공한다.">
    ...
    <tr>
      ...
      <td class="btnBackground"><input type="submit" value="<spring:message code="button.inquire" />" onclick="fn_egov_search_NoteTrnsmit(); return false;" class="btnNew" style="height:20px;width:26px;" ></td>
      <td><img src="<c:out value="${ImgUrl}"/>button/bu2_right.gif" width="8" height="20" alt="버튼이미지"></td>
      <th scope="col">&nbsp;</th>
      <td><img src="${ImgUrl}button/bu2_left.gif"  width="8" height="20" alt="버튼이미지"></td>
      <td class="btnBackground"><input type="button" value="삭제" onclick="fn_egov_delete_NoteTrnsmit(); return false;" class="btnNew" style="height:20px;width:26px;" ></td>
      <td><img src="<c:out value="${ImgUrl}"/>button/bu2_right.gif" width="8" height="20" alt="버튼이미지"></td>
    </tr>
   </table>
  </th>
