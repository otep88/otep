	...
	private String bndeRegist(InputStream inputStream)throws Exception{
	    ...
	    try {
	    	...
	    	*/
	    	...
	    	if(progrmManageDAO.selectProgrmListTotCnt()>1){ return requestValue = "99";} //프로그램목록테이블 데이타 존재오류.
	    	if(menuManageDAO.selectMenuListTotCnt()>1){ return requestValue = "99";} //메뉴정보테이블 데이타 존재오류.
