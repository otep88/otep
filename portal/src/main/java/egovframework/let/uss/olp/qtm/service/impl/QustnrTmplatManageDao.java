...
public class QustnrTmplatManageDao extends EgovAbstractDAO {
	...
	public Map selectQustnrTmplatManageTmplatImagepathnm(QustnrTmplatManageVO qustnrTmplatManageVO){
		return (Map)getSqlMapClientTemplate().queryForObject("QustnrTmplatManage.selectQustnrTmplatManageTmplatImagepathnm", qustnrTmplatManageVO);
	}
	...
	public List selectQustnrTmplatManageList(ComDefaultVO searchVO){
		return (List)list("QustnrTmplatManage.selectQustnrTmplatManage", searchVO);
	}
	...
	public List selectQustnrTmplatManageDetail(QustnrTmplatManageVO qustnrTmplatManageVO){
		return (List)list("QustnrTmplatManage.selectQustnrTmplatManageDetail", qustnrTmplatManageVO);
	}
	...
	public int selectQustnrTmplatManageListCnt(ComDefaultVO searchVO){
		return (Integer)getSqlMapClientTemplate().queryForObject("QustnrTmplatManage.selectQustnrTmplatManageCnt", searchVO);
	}
