package egovframework.let.uss.ion.ntr.service.impl;
...
public class NoteRecptnDao extends EgovComAbstractDAO {
    ...
    public List selectNoteRecptnList(NoteRecptn noteRecptn) throws Exception {
    	return (List)list("NoteRecptn.selectNoteRecptn", noteRecptn);
    }
    ...
    public int selectNoteRecptnListCnt(NoteRecptn noteRecptn) throws Exception {
    	return (Integer)getSqlMapClientTemplate().queryForObject("NoteRecptn.selectNoteRecptnCnt", noteRecptn);
    }
    ...
    public Map selectNoteRecptnDetail(NoteRecptn noteRecptn) throws Exception {
    	return (Map)getSqlMapClientTemplate().queryForObject("NoteRecptn.selectNoteRecptnDetail", noteRecptn);
    }
    ...
    public int selectNoteTrnsmitRelationCnt(NoteRecptn noteRecptn) throws Exception {
    	return (Integer)getSqlMapClientTemplate().queryForObject("NoteRecptn.selectNoteTrnsmitRelationCnt", noteRecptn);
    }
    ...
    public int selectNoteRecptnRelationCnt(NoteRecptn noteRecptn) throws Exception {
    	return (Integer)getSqlMapClientTemplate().queryForObject("NoteRecptn.selectNoteRecptnRelationCnt", noteRecptn);
    }
}
