package egovframework.let.uss.ion.pwm.web;
...
public class EgovPopupManageController {
    ...
    public String egovPopupManageUpdt(
        ...
        if (sCmd.equals("save")) {
            ...
            //아이디 설정
            popupManageVO.setFrstRegisterId((String)loginVO.getUniqId());
            popupManageVO.setLastUpdusrId((String)loginVO.getUniqId());
            //저장
    ...
    public String egovPopupManageRegist(
        ...
        String sCmd = commandMap.get("cmd") == null ? "" : (String) commandMap.get("cmd");
        log.info("cmd =>" +(String)commandMap.get("cmd"));
