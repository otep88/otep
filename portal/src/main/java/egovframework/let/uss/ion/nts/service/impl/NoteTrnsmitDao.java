package egovframework.let.uss.ion.nts.service.impl;
...
import egovframework.let.uss.ion.nts.service.NoteTrnsmit;
/**
...
public class NoteTrnsmitDao extends EgovComAbstractDAO {
    ...
    public List selectNoteTrnsmitList(NoteTrnsmit noteTrnsmit) throws Exception {
    	return (List)list("NoteTrnsmit.selectNoteTrnsmit", noteTrnsmit);
    }
    ...
    public int selectNoteTrnsmitListCnt(NoteTrnsmit noteTrnsmit) throws Exception {
    	return (Integer)getSqlMapClientTemplate().queryForObject("NoteTrnsmit.selectNoteTrnsmitCnt", noteTrnsmit);
    }
    ...
    public Map selectNoteTrnsmitDetail(NoteTrnsmit noteTrnsmit) throws Exception {
    	return (Map)getSqlMapClientTemplate().queryForObject("NoteTrnsmit.selectNoteTrnsmitDetail", noteTrnsmit);
    }
    ...
    public int selectTrnsmitRelationCnt(NoteTrnsmit noteTrnsmit) throws Exception {
    	return (Integer)getSqlMapClientTemplate().queryForObject("NoteTrnsmit.selectTrnsmitRelationCnt", noteTrnsmit);
    }
    ...
    public List selectNoteTrnsmitCnfirm(NoteTrnsmit noteTrnsmit) throws Exception {
    	return (List)list("NoteTrnsmit.selectNoteTrnsmitCnfirm", noteTrnsmit);
    }
}
