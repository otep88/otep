package egovframework.let.uss.ion.ntm.web;
...
import egovframework.let.uss.ion.ntm.service.EgovNoteManageService;
import egovframework.let.uss.ion.ntm.service.NoteManage;
...
public class EgovNoteManageController {
    ...
    public String EgovNoteRecptnRegistForm(NoteManage noteManage,@CommandMap Map commandMap,ModelMap model) throws Exception {
    	...
    	if(sCmd.equals("reply")){
    		...
    		Map mapNoteManage = (Map)egovNoteManageService.selectNoteManage(noteManage);
    		...
    		*/
    		...
    		model.addAttribute("noteManage", new NoteManage());
    	}
    	
    	return "uss/ion/ntm/EgovNoteManage";
    ...
    public String EgovNoteRecptnRegist(
    	...
    	String sLocationUrl = "uss/ion/ntm/EgovNoteManage";
        ...
        if(bindingResult.hasErrors()){
        	model.addAttribute("noteManage", (NoteManage)noteManage);
            return sLocationUrl;
        }
        //로그인 객체 선언
        ...
        //아이디 설정
        noteManage.setFrstRegisterId((String)loginVO.getUniqId());
        noteManage.setLastUpdusrId((String)loginVO.getUniqId());
    ...
    public String EgovEgovNoteEmpList(
	        ...
	        int totCnt = (Integer)egovNoteManageService.selectNoteEmpListPopupCnt(searchVO);
	        paginationInfo.setTotalRecordCount(totCnt);
	        model.addAttribute("paginationInfo", paginationInfo);
     
    	return "uss/ion/ntm/EgovNoteEmpList";
    }
