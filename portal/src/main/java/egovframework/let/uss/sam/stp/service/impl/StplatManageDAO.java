...
public class StplatManageDAO extends EgovAbstractDAO {
    ...
    public StplatManageVO selectStplatDetail(StplatManageVO vo) throws Exception {
        ...
        return (StplatManageVO) selectByPk("StplatManageDAO.selectStplatDetail", vo);
    ...
    public int selectStplatListTotCnt(StplatManageDefaultVO searchVO) {
        ...
        return (Integer)getSqlMapClientTemplate().queryForObject("StplatManageDAO.selectStplatListTotCnt", searchVO);
