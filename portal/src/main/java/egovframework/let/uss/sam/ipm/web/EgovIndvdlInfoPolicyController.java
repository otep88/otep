...
public class EgovIndvdlInfoPolicyController {
    ...
    public String EgovIndvdlInfoPolicyList(
            @ModelAttribute("searchVO") ComDefaultVO searchVO, @CommandMap Map commandMap,
        ...
        int totCnt = (Integer) egovIndvdlInfoPolicyService.selectIndvdlInfoPolicyListCnt(searchVO);
    ...
    public String EgovIndvdlInfoPolicyDetail(
            ...
            IndvdlInfoPolicy indvdlInfoPolicy, @CommandMap Map commandMap,
    ...
    public String EgovIndvdlInfoPolicyModify(
        ...
        if (sCmd.equals("save")) {
            ...
            //아이디 설정
            indvdlInfoPolicy.setFrstRegisterId((String)loginVO.getUniqId());
            indvdlInfoPolicy.setLastUpdusrId((String)loginVO.getUniqId());
