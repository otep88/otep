...
public class EgovBBSAttributeManageController {
  ...
  //SHT-CUSTOMIZING//private EgovClubManageService clubService;		// 동호회 운영자 권한 확인
    ...
    public String selectBBSMasterInfByTrget(@ModelAttribute("searchVO") BoardMasterVO boardMasterVO, @CommandMap Map<String, Object> commandMap, ModelMap model)
	    throws Exception {
    ...
    public String selectAllBdMstrByTrget(@CommandMap Map<String, Object> commandMap, ModelMap model) throws Exception {
	String trgetId = (String)commandMap.get("param_trgetId");
	BoardMasterVO vo = new BoardMasterVO();
