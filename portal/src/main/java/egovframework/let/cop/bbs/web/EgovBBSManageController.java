...
import egovframework.let.cop.bbs.service.EgovBBSCommentService;
...
public class EgovBBSManageController {
	...
	//Logger.getLogger(this.getClass()).debug(this.getClass().getName() + " user.getName() "+ user.getName());
	//Logger.getLogger(this.getClass()).debug(this.getClass().getName() + " user.getUniqId() "+ user.getUniqId());
	//Logger.getLogger(this.getClass()).debug(this.getClass().getName() + " user.getOrgnztId() "+ user.getOrgnztId());
	//Logger.getLogger(this.getClass()).debug(this.getClass().getName() + " user.getUserSe() "+ user.getUserSe());
	//Logger.getLogger(this.getClass()).debug(this.getClass().getName() + " user.getEmail() "+ user.getEmail());
