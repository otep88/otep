...
public class EgovTemplateManageController {
    ...
    public String selectTemplateInfsPop(@ModelAttribute("searchVO") TemplateInfVO tmplatInfVO, @CommandMap Map<String, Object> commandMap, ModelMap model)
	    throws Exception {
    ...
    public String openPopupWindow(@CommandMap Map<String, Object> commandMap, ModelMap model) throws Exception {
