...
<c:set var="ImgUrl" value="/images/egovframework/com/uss/ion/ntm/"/>
<c:set var="CssUrl" value="/css/"/>
<%--  자마스크립트 메세지 출력 --%>
${reusltScript}
...
function fn_egov_recptnEmpOption_NoteManage(sText,sValue,sRecptnSe){
	//수신자가 중복 될때 빠져 나가기
	if(fn_egov_recptnEmpSearch_NoteManage(sValue)){return;};
...
<tr>
   ...
   <!--  수신자  목록/찾기 영역  -->
	<div style="float:left;padding:0px 10px 0px 0px;border:solid 0px #000000;">
		...
		<tr>
			...
			<tr>
			     <th scope="col" style="padding:0 0 0 0;"><img src="${ImgUrl}button/bu2_left.gif"  width="8" height="20" alt="버튼이미지"></th>
			     <td class="btnBackground"><a href="#LINK" onClick="fn_egov_delete_NoteManage(1);">삭제</a></td>
			     <td style="padding:0 0 0 0;"><img src="<c:out value="${ImgUrl}"/>button/bu2_right.gif" width="8" height="20" alt="버튼이미지"></td>
			     <td style="padding:0 0 0 0;background-color:#f7f7f7;">&nbsp;</td>

			     <td style="padding:0 0 0 0;"><img src="${ImgUrl}button/bu2_left.gif"  width="8" height="20" alt="버튼이미지"></td>
   ...
   <div style="float:left;height:20px;padding:80px 10px 0px 0px;border:solid 0px #000000;">
	<a href="/uss/ion/ntm/listEgovNoteEmpListPopup.do" target="_blank" title="수신자/참조자 선택  팝업 새창으로" onclick="fn_egov_popupOpen_PopupManage('/uss/ion/ntm/listEgovNoteEmpListPopup.do','empPopup',760,400);return false"><img src="<c:url value='/images/egovframework/com/cmm/search2.gif'/>" alt="수신자찾기버튼" title="수신자찾기버튼"></a>
   </div>
...
<tr>
  <th scope="col"><img src="${ImgUrl}button/bu2_left.gif"  width="8" height="20" alt="버튼이미지"></th>
  ...
  <td><img src="${ImgUrl}button/bu2_right.gif"  width="8" height="20" alt="버튼이미지"></td>
</tr>
</table>
</center>
</form:form>
